...
function Deposit() {
    ...
    async function getDep() {
        ...
        const depositAmount = Number(amt);
        ...
        const updatedAccount = { ...account, amount: updatedAmount };

        await axios.put(`http://localhost:3000/account/${account.id}`, updatedAccount);
        ...
        setMsg("Deposit successful. Your current balance is ₹" + updatedAmount);
    }
    ...
    return (
        <div className="page-shell">
            <div className="page-title">
                ...
                <p>Deposit money directly into account {acno || ""}.</p>
            </div>
            ...
            <div className="row form-row">
                <div className="col-md-6 premium-card form-card">
                    ...
                    <div className="form-field">Enter Amount to Deposit
                        <input type="number" className="form-control premium-input" onInput={(e) => setAmt(e.target.value)} />
                    </div>

                    <center>
                        <button className="premium-btn" onClick={getDep}>
                            Deposit
                        </button>
                    </center>
                </div>
            ...
            <div className="app-footer">
                <p>
                    ...
                    <span>© 2026 Creasta Bank | Easy & Secure Deposits Anytime</span>
                </p>
            </div>
        </div>
    );
